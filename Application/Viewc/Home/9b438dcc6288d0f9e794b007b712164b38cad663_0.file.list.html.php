<?php
/* Smarty version 3.1.32, created on 2018-11-28 22:03:17
  from 'D:\wamp\www\go\Blog-2\Application\View\Home\list.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5bfea025634555_72952298',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9b438dcc6288d0f9e794b007b712164b38cad663' => 
    array (
      0 => 'D:\\wamp\\www\\go\\Blog-2\\Application\\View\\Home\\list.html',
      1 => 1538291199,
      2 => 'file',
    ),
  ),
...
function content_5bfea025634555_72952298 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'D:\\wamp\\www\\go\\Blog-2\\Framework\\Core\\Smarty\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
...
<div id="divAll">
	...
	<div id="divMiddle">
		...
		<div id="divNavBar">
			<ul>
				<li id="nvabar-item-index"><a href="index.php?p=Home&c=Index&a=index">返回首页</a></li><li id="navbar-page-2"><a href="">文章列表</a></li>			</ul>
		</div>
		<div id="divMain">
	<?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<!-- <div class="pagebar" > 
	  <span>当前一共有3条记录，当前每页显示8条记录，当前是第1页！</span>&nbsp;&nbsp;		
	  <a href="index.php?module=Index&action=index&page=1">首页</a>&nbsp;&nbsp;
	  <a href="index.php?module=Index&action=index&page=1">上一页</a>&nbsp;&nbsp;
	  <a href="index.php?module=Index&action=index&page=1">下一页</a>&nbsp;&nbsp;
	  <a href="index.php?module=Index&action=index&page=1">末页</a>&nbsp;&nbsp;<a href='index.php?module=Index&action=index&page=1'>1</a>&nbsp;&nbsp;
	</div> -->
</div>
<div id="divSidebar">
